...
export function adminWorkPlanning() {
  ...
  return `${workHeader(work, "Cronograma", "Organize os itens da planilha em quadros, datas e relações de precedência.", `<button class="btn" data-message="save-node-plan">Salvar cronograma</button>`)}
    <div class="diagram-help"><span><b>1</b> Arraste o fundo para mover a área</span><span><b>2</b> Arraste os quadros</span><span><b>3</b> Puxe a porta azul para criar a seta</span><span><b>4</b> Edite a relação no meio da linha</span></div>
...
export function adminDiagramLibrary() {
  return `${pageHeader("Modelos de diagramas", "A mesma interação de quadros, setas e inputs de aresta é reutilizada no sistema.")}
    <section class="template-grid"><article><b>01</b><h3>Cronograma da obra</h3><p>Itens e datas transformados em calendário.</p></article><article><b>02</b><h3>Fluxo de compras</h3><p>Stickers encadeados por estágio.</p></article><article><b>03</b><h3>Organograma do RH</h3><p>Equipes, funções e relações.</p></article></section>`;
}
