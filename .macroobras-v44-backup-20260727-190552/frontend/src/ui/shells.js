...
function renderSidebar({
  ...
  return `
    <button
      ...
      aria-label="${
        hoverMode
          ? "Fixar subnavegação aberta"
          : "Recolher subnavegação para abrir ao passar o mouse"
      }"
      title="${hoverMode ? "Fixar menu aberto" : "Recolher menu"}"
    >
      <span
        class="sidebar-fold-corner"
        aria-hidden="true"
      ></span>
      ${shellIcon(
        hoverMode
      ...
      <header class="sidebar-subnav-header">
        ...
        <button
          ...
          aria-label="${
            hoverMode
              ? "Fixar subnavegação"
              : "Usar expansão ao passar o mouse"
          }"
          title="${
            hoverMode
              ? "Fixar subnavegação"
              : "Usar expansão por hover"
          }"
        >
          ${shellIcon(
            hoverMode
