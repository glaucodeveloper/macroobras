...
export const routes = [
  ...
  { route: "admin-work-planning", label: "Planejamento por nós", mode: "admin", parent: "admin-works", workRoute: true },
  ...
  { route: "admin-access", label: "Acessos do mestre", mode: "admin", parent: "admin-settings" },
...
export const subNavigation = {
  ...
  "admin-work": [
    ...
    { route: "admin-work-planning", label: "Planejamento por nós" },
  ...
  "admin-settings": [
    ...
    { route: "admin-access", label: "Acessos do mestre" },
...
export const mobileUsers = [
  { name: "Encarregado da obra", email: "encarregado@macroobras.local", cpf: "123.456.789-09", workId: "obra-buerarema-estadio" },
...
export const initialCollaboratorStatus = {
  ...
  publicApiUrl: "",
  message: "Plataforma mobile local preparada; túnel ngrok aguardando ativação.",
};
...
export const initialInstallerStatus = { installDir: "", ftpHost: "192.168.0.24", ftpPort: "2121", collaboratorEndpoint: "", archiveEndpoint: "", pathReady: false, ftpReady: false, endpointReady: false, archiveReady: false, needsAdmin: true, message: "Aguardando configuração", commands: [] };
