...
function shellIcon(name) {
  const paths = {
    ...
    inventory: '<path d="M4 7h24v20H4V7zm4 4v4h6v-4H8zm10 0v4h6v-4h-6zM8 19v4h6v-4H8zm10 0v4h6v-4h-6z"/>',
    tickets: '<path d="M5 5h22v7a4 4 0 0 0 0 8v7H5v-7a4 4 0 0 0 0-8V5zm7 4v14h3V9h-3zm6 0v14h3V9h-3z"/>',
